...
@pytest.mark.parametrize("filename, success, error_list", [
    ...
    ("test_semantic_invalid_device_output.txt", False,
        [Parser.INVALID_DEVICE_OUTPUT_ERROR]),
    ("test_semantic_invalid_port.txt", False, [Parser.INVALID_PORT_ERROR]),
    ("test_semantic_keyword.txt", False, [Parser.KEYWORD_ERROR] * 2 + \
        [Parser.SYNTAX_ERROR]),
    ...
    ("test_semantic_out_of_bounds_inputs.txt", False,
        [Parser.OUT_OF_BOUND_INPUTS_ERROR]),
    ...
    ("test_semantic_repeated_monitor.txt", False,
        [Parser.REPEATED_MONITOR_ERROR]),
    ("test_semantic_undefined_device.txt", False,
        [Parser.UNDEFINED_DEVICE_ERROR]),
    ("test_semantic_unmatched_input_output.txt", False,
        [Parser.UNMATCHED_INPUT_OUTPUT_ERROR]),
    # Syntax error files
    ...
    ("test_syntax_invalid_port.txt", False,
        [Parser.SYNTAX_ERROR, Parser.SYNTAX_ERROR]),
    ("test_syntax_invalid_signal.txt", False,
        [Parser.SYNTAX_ERROR, Parser.SYNTAX_ERROR]),
    ...
    ("test_syntax_mon_def_missing_semicolon.txt", False,
        [Parser.SYNTAX_ERROR]),
    ("test_syntax_no_devices.txt", False,
        [Parser.KEYWORD_ERROR, Parser.SYNTAX_ERROR]),
